...
public class RedPropPipeline extends OpenCvPipeline {
    ...
    Scalar RED = new Scalar(168,0,32);

    // Red                         Y      Cr     Cb    (Do not change Y)
    public static Scalar scalarLowerYCrCb = new Scalar(0.0, 180.0, 0.0);
    ...
    public RedPropPipeline(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
